...
def assert_release_jobs(workflow: dict[str, Any]) -> None:
    ...
    assert_job(
        ...
        steps=[
            ...
            StepCheck(name="Wait for biors-core index", run_contains=["cargo search biors-core"]),
            ...
            StepCheck(name="Wait for biors-backend-candle index", run_contains=["cargo search biors-backend-candle"]),
    ...
    assert_job(
        ...
        steps=[
            ...
            StepCheck(name="Install maturin", run_contains=['"maturin==${BIORS_RELEASE_MATURIN_VERSION}"']),
    ...
    assert_job(
        ...
        steps=[
            ...
            StepCheck(name="Install wasm-pack", run_contains=['cargo install wasm-pack --locked --version "${BIORS_RELEASE_WASM_PACK_VERSION}"']),
