...
def run_node_benchmark(pkg_dir: Path, fasta_path: Path, input_info: dict, loops: int) -> list[dict]:
...
def main() -> int:
    ...
    workloads = run_node_benchmark(pkg_dir, fasta_path, input_info, args.loops)
    result = {
