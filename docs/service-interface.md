...
The service is a local researcher-callable integration surface, not the primary
product surface. Use it when researcher tools or research agents need loopback
HTTP JSON around the same local validation contracts exposed by the CLI and
MCP.
