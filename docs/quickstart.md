...
The quickstart exercises the researcher-callable CLI side of bio-rs: local
validation, model-ready input preparation, package checks, and reproducible
JSON outputs that research agents can also call through MCP.
