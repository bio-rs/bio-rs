...
- [ ] WASM/npm changes: ran `wasm-pack test --node crates/biors-wasm` and checked npm package contents
...
- [ ] README first-screen positioning still reflects the AI-ready biological data I/O, validation, and tokenization engine, not only one FASTA path
